...
from ..data_classes.completion import *  # TODO Fix
...
class CompletionAPI:
    ...
    def get_raw_data(
        ...
        """Retrieves all raw data from Rushmore Completion Performance Review.

        Args:
            filter: Filtering string according to API specification.

        Returns:
            List of dicts where each dict describes a well in the Completion
            Performance Review.
    ...
    #         >>> e.completion.get_processed_data(filter)
